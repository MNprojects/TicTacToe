...
selectMode = function(){
  console.log("Select the game mode you would like to play by typing the corresponding number. \n"
  +" 1. Human vs Computer \n"
  +" 2. Human vs Human \n"
  ...
  process.openStdin().on('data',function(res){
    ...
    if(res == 1){
      console.log("Selected human vs computer")
      playHvC()
    } else if(res == 2) {
      console.log("Selected human vs human")
      playHvH()
    } else if(res == 3){
      console.log("Selected computer vs computer")
      playCvC()
    } else {
